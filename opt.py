...
def get_opts():
    ...
    parser.add_argument('--val_check_interval', type=float, default=0.15,
                        help='validation check interval per epoch')
    # for blender
    ...
    parser.add_argument('--fewshot', type=int, default=-1, 
                        help='the number of images to use in fewshot')
...
#                         help='number of training epochs')
    parser.add_argument('--num_steps', type=int, default=6000000,
                        help='number of training epochs')
    ...
    ###########################
    #### params for optimize_apearance
    parser.add_argument('--seed', type=int, default=4,
                        help='seed')
    parser.add_argument('--data_idx', type=int,
                        help='data_idx')
    parser.add_argument('--use_mean_embedding', default=False, action="store_true",
                        help='whether to use mean appearance embedding')
